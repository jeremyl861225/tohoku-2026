...
PTS = [
    ...
    ("松島",     141.060, 38.372, "stay", "1",  "start",  9,  4, "matsushima-cruise"),
    ("平泉",     141.099, 38.993, "stop", "",   "start",  9,  4, "chusonji"),
    ("角館",     140.562, 39.594, "stop", "",   "end",   -9,  4, "kakunodate"),
    ("田澤湖",   140.670, 39.710, "stop", "",   "end",   -9, -3, "tazawako"),
    ("乳頭溫泉", 140.790, 39.790, "stay", "2",  "start",  9,  1, "nyuto"),
    ("十和田湖", 140.889, 40.464, "stay", "3",  "end",   -9,  4, "towadako"),
    ("奧入瀨",   140.960, 40.550, "stop", "",   "start",  9,  3, "oirase"),
    ("八甲田",   140.858, 40.654, "stop", "",   "start",  8, -5, "hakkoda"),
    ("弘前",     140.464, 40.603, "stay", "4",  "end",   -9,  4, "hirosaki-park"),
    ("千疊敷",   140.100, 40.667, "stop", "",   "end",   -9, -2, "senjojiki"),
    ("深浦",     139.907, 40.573, "stop", "",   "end",   -9,  4, "furofushi"),
    ("十二湖",   139.926, 40.413, "stop", "",   "end",   -9,  4, "aoike"),
    ("秋田市",   140.103, 39.720, "stay", "5",  "end",   -9,  4, "senshu-park"),
]
...
svg = "\n".join(s)
open("map_i.svg", "w", encoding="utf-8").write(svg)
